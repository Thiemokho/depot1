...
function fullhouse_fnc_cst_customizer($wp_customize){
   ...
   /**
    ...
    $wp_customize->add_setting('pbr_theme_options[stickysidebar]', array(
        'capability' => 'edit_theme_options',
        'type'       => 'option',
        'default'   => 0,
        'checked' => 1,
    ...
    $wp_customize->add_control('pbr_theme_options[stickysidebar]', array(
        'settings'  => 'pbr_theme_options[stickysidebar]',
        'label'     =>  esc_html__( 'Sticky Sidebar', 'fullhouse' ),
        'section'   => 'ts_general_settings',
        'type'      => 'checkbox',
        'transport' => 4,
    ) );
