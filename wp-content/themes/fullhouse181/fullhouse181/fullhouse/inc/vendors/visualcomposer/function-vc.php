...
function fullhouse_video_display() {
...
add_action( 'wp_ajax_video_display', 'fullhouse_video_display' );
add_action( 'wp_ajax_nopriv_video_display', 'fullhouse_video_display' );

function fullhouse_youtube_embed_url($html) {
    return str_replace("?feature=oembed", "?feature=oembed&autoplay=1", $html);
}
add_filter('oembed_result', 'fullhouse_youtube_embed_url');