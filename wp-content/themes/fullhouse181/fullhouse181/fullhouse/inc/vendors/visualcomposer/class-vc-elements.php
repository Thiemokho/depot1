...
class Fullhouse_VC_Elements implements Vc_Vendor_Interface {
	...
	public function load(){ 
		...
		**********************************************************************************************************************/
		vc_map( array(
	        "name" => esc_html__("PBR Video Background",'fullhouse'),
	        "base" => "pbr_video_carousel",
	        'icon' => 'icon-wpb-widgets-13',
	        "class" => "",
	    	"category" => esc_html__('PBR Widgets','fullhouse'),
	    	"description"	=> esc_html__( 'Display video carousel', 'fullhouse' ),
	        "params" => array(
	        	array(
	                "type" => "textfield",
	                "class" => "",
            	...
            	array(
					'type' => 'param_group',
					'heading' => esc_html__('Carousel Items', 'fullhouse' ),
					'param_name' => 'items',
					'description' => '',
					'value' => '',
					'params' => array(
						...
						array(
			                "type" => "textfield",
			                "class" => "",
			                "heading" => esc_html__('Video Link','fullhouse'),
			                "param_name" => "video_link",
			                "description" => esc_html__('Enter Youtube, Vimeo video url', 'fullhouse')
			            ),
